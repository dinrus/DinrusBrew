...
class CacheStoreDatabase
  ...
  # database file will be created in the `DRXHUB_CACHE` with a name
  ...
  # The path where the database resides in the `DRXHUB_CACHE` for the given
  # `@type`.
  #
  # @return [String]
  def cache_path
    DRXHUB_CACHE/"#{@type}.json"
  end
