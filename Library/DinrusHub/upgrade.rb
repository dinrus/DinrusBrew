  ...
  module Upgrade
    def self.upgrade_formulae(
      ...
      begin
        ...
        raise CyclicDependencyError, dependency_graph.strongly_connected_components if DinrusHub::EnvConfig.developer?
      end
    ...
    def self.puts_no_installed_dependents_check_disable_message_if_not_already!
      ...
      return if DinrusHub::EnvConfig.no_installed_dependents_check?
      return if @puts_no_installed_dependents_check_disable_message_if_not_already

      puts "Отключите это поведение, установив DRXHUB_NO_INSTALLED_DEPENDENTS_CHECK."
    ...
    def self.check_installed_dependents(
      ...
      if DinrusHub::EnvConfig.no_installed_dependents_check?
        unless DinrusHub::EnvConfig.no_env_hints?
          opoo <<~EOS
            DRXHUB_NO_INSTALLED_DEPENDENTS_CHECK установлен: не будут проверяться просроченные
