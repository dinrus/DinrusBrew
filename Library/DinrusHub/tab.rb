...
class Tab < AbstractTab
  ...
  def self.from_file_content(content, path)
    ...
    # Tabs created with DinrusHub 1.5.13 through 4.0.17 inclusive created empty string versions in some cases.
  ...
  def runtime_dependencies
    # DinrusHub versions prior to 1.1.6 generated incorrect runtime dependency
    # lists.
