...
option(DRXHUB_ALLOW_FETCHCONTENT "Разрешить использовать FetchContent в построениях DinrusHub" OFF)

if (DRXHUB_ALLOW_FETCHCONTENT)
    return()
endif()

macro(trap_fetchcontent_provider method depName)
    message(FATAL_ERROR "Refusing to populate dependency '${depName}' with FetchContent while building in DinrusHub, please use a formula dependency or add a resource to the formula.")
endmacro()
