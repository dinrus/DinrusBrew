...
module Cask
  ...
  module Quarantine
    ...
    QUARANTINE_SCRIPT = (DRXHUB_LIBRARY_PATH/"cask/utils/quarantine.swift").freeze
    COPY_XATTRS_SCRIPT = (DRXHUB_LIBRARY_PATH/"cask/utils/copy-xattrs.swift").freeze
    ...
    # Ensures that DinrusHub has permission to update apps on macOS Ventura.
    ...
    def self.app_management_permissions_granted?(app:, command:)
      ...
      opoo <<~EOF
        Your terminal does not have App Management permissions, so DinrusHub will delete and reinstall the app.
