...
module Stdenv
  ...
  def homebrew_extra_pkg_config_paths
    [Pathname("#{DRXHUB_LIBRARY}/DinrusHub/os/mac/pkgconfig/#{MacOS.version}")]
  end
  ...
  def remove_macosxsdk(version = nil)
    ...
    delete("CPATH")
    remove "LDFLAGS", "-L#{DRXHUB_PREFIX}/lib"
  ...
  def macosxsdk(version = nil, formula: nil, testing_formula: false)
    ...
    self["CPATH"] = "#{DRXHUB_PREFIX}/include"
    prepend "LDFLAGS", "-L#{DRXHUB_PREFIX}/lib"
