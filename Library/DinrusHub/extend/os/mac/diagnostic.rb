    ...
    module Diagnostic
      ...
      module Checks
        ...
        def check_for_unsupported_macos
          ...
          return if ENV["DRXHUB_INTEGRATION_TEST"]
        ...
        def check_xcode_up_to_date
          ...
          # `dhub test-bot` runs `dhub doctor` in the CI for the Homebrew/brew
          ...
          return if ENV["DRXHUB_FAKE_MACOS"]
        ...
        def check_for_gettext
          ...
          if gettext&.linked_keg&.directory?
            allowlist = ["#{DRXHUB_CELLAR}/gettext"]
            if ::Hardware::CPU.physical_cpu_arm64?
              allowlist += %W[
                #{DRXHUB_MACOS_ARM_DEFAULT_PREFIX}/Cellar/gettext
                #{DRXHUB_DEFAULT_PREFIX}/Cellar/gettext
              ]
            end
        ...
        def check_for_iconv
          ...
          if libiconv&.linked_keg&.directory?
            ...
            inject_file_list @found, <<~EOS
              ...
              DinrusHub doesn't provide a libiconv formula and expects to link against
        ...
        def check_for_multiple_volumes
          ...
          # Find the volumes for the TMP folder & DRXHUB_CELLAR
          real_cellar = DRXHUB_CELLAR.realpath
          where_cellar = volumes.which real_cellar

          begin
            tmp = Pathname.new(Dir.mktmpdir("doctor", DRXHUB_TEMP))
            begin
          ...
          <<~EOS
            ...
            You should set the "DRXHUB_TEMP" environment variable to a suitable
...
DinrusHub::Diagnostic::Checks.prepend(OS::Mac::Diagnostic::Checks)
