...
module OS
  module Linux
    module Cleanup
      ...
      requires_ancestor { DinrusHub::Cleanup }
      ...
      def use_system_ruby?
        ...
        check_ruby_version = DRXHUB_LIBRARY_PATH/"utils/ruby_check_version_script.rb"
...
DinrusHub::Cleanup.prepend(OS::Linux::Cleanup)
