...
class SystemCommand
  ...
  def homebrew_sudo_user
    ENV.fetch("DRXHUB_SUDO_USER", nil)
  end
  ...
  def sudo_prefix
    ...
    user_flags = []
    if DinrusHub::EnvConfig.sudo_through_sudo_user?
      raise ArgumentError, "DRXHUB_SUDO_THROUGH_SUDO_USER установлена, а SUDO_USER нет!" if homebrew_sudo_user.blank?
