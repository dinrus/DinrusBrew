  ...
  module DevCmd
    class Typecheck < AbstractCommand
      ...
      def run
        ...
        groups = update ? DinrusHub.valid_gem_groups : ["typecheck"]
        DinrusHub.install_bundler_gems!(groups:)
        ...
        DRXHUB_LIBRARY_PATH.cd do
          if update
            ...
            # Prefer adding args here: Library/DinrusHub/sorbet/tapioca/config.yml
