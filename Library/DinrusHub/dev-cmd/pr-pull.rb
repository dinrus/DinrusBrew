    ...
    class PrPull < AbstractCommand
      ...
      def run
        ...
        args.named.uniq.each do |arg|
          ...
          dir = Dir.mktmpdir("pr-pull-#{pr}-", DRXHUB_TEMP)
          begin
            cd dir do
              ...
              safe_system DRXHUB_BREW_FILE, *upload_args
            end
          ensure
      ...
      def changed_packages(tap, original_commit)
        formulae = Utils.popen_read("git", "-C", tap.path, "diff-tree",
          ...
          if DinrusHub::EnvConfig.disable_load_formula?
            opoo "Can't check if updated bottles are necessary as DRXHUB_DISABLE_LOAD_FORMULA is set!"
            break
          end
          begin
