      ...
      class Text < FormulaCop
        ...
        def audit_formula(formula_nodes)
          ...
          if formula_tap == "homebrew-core"
            ...
            if find_node_method_by_name(body_node, :keg_only)&.source&.include?("DRXHUB_PREFIX")
              problem "`keg_only` reason should not include `DRXHUB_PREFIX` " \
                      "as it creates confusing `dhub info` output."
            end
          end
