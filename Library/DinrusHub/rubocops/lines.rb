...
module RuboCop
  module Cop
    module FormulaAudit
      # This cop checks for various miscellaneous DinrusHub coding styles.
      ...
      class Miscellaneous < FormulaCop
        ...
        def audit_formula(formula_nodes)
          ...
          find_method_with_args(body_node, :skip_clean, :all) do
            problem "`skip_clean :all` is deprecated; dhub no longer strips symbols. " \
                    "Pass explicit paths to prevent DinrusHub from removing empty folders."
          end
          ...
          find_instance_method_call(body_node, "ENV", :[]) do |method|
            ...
            problem 'Don\'t use ENV["CI"] for DinrusHub CI checks.'
          end
