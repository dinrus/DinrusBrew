  ...
  def install
    ...
    with_env(new_env) do
      ...
      formula.dhub(
        ...
        with_env(
          # For head builds, DRXHUB_FORMULA_PREFIX should include the commit,
          # which is not known until after the formula has been staged.
          DRXHUB_FORMULA_PREFIX:    formula.prefix,
          # https://reproducible-builds.org/docs/build-path/
          DRXHUB_FORMULA_BUILDPATH: formula.buildpath,
...
begin
  ...
  args = DinrusHub::Cmd::InstallCmd.new.args
