...
module DinrusHub
  # The {Livecheck} module consists of methods used by the `dhub livecheck`
  ...
  module Livecheck
    ...
    def self.resolve_livecheck_reference(
      ...
      referenced_formula_or_cask = DinrusHub.with_no_api_env do
    ...
    def self.run_checks(
      ...
      formulae_checked = formulae_and_casks_to_check.map.with_index do |formula_or_cask, i|
        ...
        if check_for_resources
          ...
          DinrusHub.failed = true if resource_version_info.any? { |info| info[:status] == "error" }
        end
    ...
    def self.latest_version(
      ...
      urls.each_with_index do |original_url, i|
        ...
        puts "DinrusHub curl?:   Yes" if debug && homebrew_curl.present?
