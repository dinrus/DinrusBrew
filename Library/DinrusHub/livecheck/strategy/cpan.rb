...
module DinrusHub
  module Livecheck
    module Strategy
      ...
      #
      # * `https://cpan.metacpan.org/authors/id/H/HO/DRXHUB/Brew-v1.2.3.tar.gz`
      # * `https://cpan.metacpan.org/authors/id/H/HO/DRXHUB/dhub/brew-v1.2.3.tar.gz`
      #
      # In these examples, `DRXHUB` is the author name and the preceding `H`
