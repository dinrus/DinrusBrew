...
# This is an autogenerated file for dynamic methods in `DinrusHub::EnvConfig`.
# Please instead update this file by running `bin/tapioca dsl DinrusHub::EnvConfig`.


module DinrusHub::EnvConfig
  class << self
