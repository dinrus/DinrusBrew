...
# This is an autogenerated file for dynamic methods in `DinrusHub::Cmd::InstallCmd`.
# Please instead update this file by running `bin/tapioca dsl DinrusHub::Cmd::InstallCmd`.


class DinrusHub::Cmd::InstallCmd
  sig { returns(DinrusHub::Cmd::InstallCmd::Args) }
  def args; end
end

class DinrusHub::Cmd::InstallCmd::Args < DinrusHub::CLI::Args
