...
# This is an autogenerated file for dynamic methods in `DinrusHub::Cmd::UpgradeCmd`.
# Please instead update this file by running `bin/tapioca dsl DinrusHub::Cmd::UpgradeCmd`.


class DinrusHub::Cmd::UpgradeCmd
  sig { returns(DinrusHub::Cmd::UpgradeCmd::Args) }
  def args; end
end

class DinrusHub::Cmd::UpgradeCmd::Args < DinrusHub::CLI::Args
