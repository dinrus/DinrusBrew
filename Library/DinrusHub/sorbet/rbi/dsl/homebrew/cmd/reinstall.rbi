...
# This is an autogenerated file for dynamic methods in `DinrusHub::Cmd::Reinstall`.
# Please instead update this file by running `bin/tapioca dsl DinrusHub::Cmd::Reinstall`.


class DinrusHub::Cmd::Reinstall
  sig { returns(DinrusHub::Cmd::Reinstall::Args) }
  def args; end
end

class DinrusHub::Cmd::Reinstall::Args < DinrusHub::CLI::Args
