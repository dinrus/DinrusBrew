  ...
  module Compilers
    class Forwardables < Tapioca::Dsl::Compiler
      ...
      def self.gather_constants
        DinrusHub::Tapioca::Utils.named_objects_with_module(Forwardable).reject do |obj|
      ...
      def decorate
        root.create_path(constant) do |klass|
          DinrusHub::Tapioca::Utils.methods_from_file(constant, FORWARDABLE_FILENAME)
                                  .each { |method| compile_forwardable_method(klass, method) }
          DinrusHub::Tapioca::Utils.methods_from_file(constant, FORWARDABLE_FILENAME, class_methods: true)
