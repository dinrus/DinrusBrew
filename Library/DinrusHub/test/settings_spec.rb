...
RSpec.describe DinrusHub::Settings do
  before do
  ...
  describe ".read" do
    ...
    it "runs on a repo without a configuration file" do
      expect { described_class.read("foo", repo: DRXHUB_REPOSITORY/"bar") }.not_to raise_error
    end
  end
  ...
  describe ".write" do
    ...
    it "returns if the repo doesn't have a configuration file" do
      expect { described_class.write("foo", false, repo: DRXHUB_REPOSITORY/"bar") }.not_to raise_error
    end
  end
  ...
  describe ".delete" do
    ...
    it "returns if the repo doesn't have a configuration file" do
      expect { described_class.delete("foo", repo: DRXHUB_REPOSITORY/"bar") }.not_to raise_error
    end
  end
end
