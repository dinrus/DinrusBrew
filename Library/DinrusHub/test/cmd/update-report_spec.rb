...
RSpec.describe DinrusHub::Cmd::UpdateReport do
  ...
  describe Reporter do
    ...
    let(:reporter_class) do
      Class.new(described_class) do
        def initialize(tap)
          ...
          ENV["DRXHUB_UPDATE_BEFORE#{tap.repository_var_suffix}"] = "12345678"
          ENV["DRXHUB_UPDATE_AFTER#{tap.repository_var_suffix}"] = "abcdef00"
    ...
    specify "without revision variable" do
      ENV.delete_if { |k, _v| k.start_with? "DRXHUB_UPDATE" }
