...
RSpec.describe SPDX do
  ...
  describe ".license_expression_to_string" do
    ...
    it "returns licenses and exceptions for complex license expressions" do
      ...
      result = "MIT OR LicenseRef-DinrusHub-public-domain OR (0BSD AND Zlib) OR (curl WITH LLVM-exception)"
      expect(described_class.license_expression_to_string(license_expression)).to eq result
    end

    it "returns :public_domain" do
      expect(described_class.license_expression_to_string(:public_domain)).to eq "LicenseRef-DinrusHub-public-domain"
    end

    it "returns :cannot_represent" do
      result = "LicenseRef-DinrusHub-cannot-represent"
  ...
  describe ".string_to_license_expression" do
    ...
    it "returns :public_domain" do
      expect(described_class.string_to_license_expression("LicenseRef-DinrusHub-public-domain")).to eq :public_domain
    end

    it "returns :cannot_represent" do
      expr_string = "LicenseRef-DinrusHub-cannot-represent"
