...
RSpec.describe DinrusHub::Livecheck::SkipConditions do
  ...
  let(:formulae) do
    {
      ...
      google_code_archive: formula("test_google_code_archive") do
        ...
        homepage "https://brew.sh"
        url "https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.com/dhub/brew-1.0.0.tar.gz"
      end,
