...
RSpec.describe DinrusHub::Livecheck::Strategy::Sparkle do
  ...
  let(:items) do
    {
      v124: DinrusHub::Livecheck::Strategy::Sparkle::Item.new(
        ...
        bundle_version:         DinrusHub::BundleVersion.new(
      ...
      v123: DinrusHub::Livecheck::Strategy::Sparkle::Item.new(
      ...
      v122: DinrusHub::Livecheck::Strategy::Sparkle::Item.new(
      ...
      v121: DinrusHub::Livecheck::Strategy::Sparkle::Item.new(
      ...
      v120: DinrusHub::Livecheck::Strategy::Sparkle::Item.new(
  ...
  describe "::versions_from_content" do
    ...
    it "allows a nil return from a block" do
      expect(
        sparkle.versions_from_content(xml[:appcast]) do |item|
          _ = item # To appease `dhub style` without modifying arg name
          next
        end,
      ).to eq([])
    end
    ...
    it "errors on an invalid return type from a block" do
      ...
      end.to raise_error(TypeError, DinrusHub::Livecheck::Strategy::INVALID_BLOCK_RETURN_VALUE_MSG)
    end
