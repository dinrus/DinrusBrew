...
RSpec.describe DinrusHub::Livecheck::Strategy::PageMatch do
  ...
  let(:content) do
    <<~EOS
      ...
      <html>
        <head>
          <meta charset="utf-8">
          <title>DinrusHub — DinrusHub</title>
        </head>
        <body>
          <ul class="posts">
            <li><a href="/2020/12/01/homebrew-2.6.0/" title="2.6.0"><h2>2.6.0</h2><h3>01 Dec 2020</h3></a></li>
            <li><a href="/2020/11/18/homebrew-tap-with-bottles-uploaded-to-github-releases/" title="DinrusHub tap with bottles uploaded to GitHub Releases"><h2>DinrusHub tap with bottles uploaded to GitHub Releases</h2><h3>18 Nov 2020</h3></a></li>
            ...
            <li><a href="/2019/06/14/homebrew-maintainer-meeting/" title="DinrusHub Maintainer Meeting"><h2>DinrusHub Maintainer Meeting</h2><h3>14 Jun 2019</h3></a></li>
  ...
  describe "::versions_from_content" do
    ...
    it "errors on an invalid return type from a block" do
      expect { page_match.versions_from_content(content, regex) { 123 } }
        .to raise_error(TypeError, DinrusHub::Livecheck::Strategy::INVALID_BLOCK_RETURN_VALUE_MSG)
    end
  end
