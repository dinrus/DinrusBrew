...
RSpec.describe DinrusHub::Livecheck::Strategy::Cpan do
  subject(:cpan) { described_class }

  let(:cpan_urls) do
    {
      no_subdirectory:   "https://cpan.metacpan.org/authors/id/H/HO/DRXHUB/Brew-v1.2.3.tar.gz",
      with_subdirectory: "https://cpan.metacpan.org/authors/id/H/HO/DRXHUB/dhub/brew-v1.2.3.tar.gz",
    }
  end
  ...
  let(:generated) do
    {
      no_subdirectory:   {
        url:   "https://cpan.metacpan.org/authors/id/H/HO/DRXHUB/",
        regex: /href=.*?Brew[._-]v?(\d+(?:\.\d+)*)\.t/i,
      },
      with_subdirectory: {
        url:   "https://cpan.metacpan.org/authors/id/H/HO/DRXHUB/dhub/",
        regex: /href=.*?dhub[._-]v?(\d+(?:\.\d+)*)\.t/i,
      },
    }
  end
