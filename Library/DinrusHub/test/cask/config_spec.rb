...
RSpec.describe Cask::Config, :cask do
  ...
  describe "#env" do
    it "returns directories specified with the DRXHUB_CASK_OPTS variable" do
      ENV["DRXHUB_CASK_OPTS"] = "--appdir=/path/to/apps"
