...
RSpec.describe DinrusHub::CLI::NamedArgs do
  ...
  describe "#to_kegs" do
    before do
      (DRXHUB_CELLAR/"foo/1.0").mkpath
      (DRXHUB_CELLAR/"foo/2.0").mkpath
  ...
  describe "#to_default_kegs" do
    before do
      (DRXHUB_CELLAR/"foo/1.0").mkpath
      (DRXHUB_CELLAR/"bar/1.0").mkpath
      linked_path = (DRXHUB_CELLAR/"foo/2.0")
      linked_path.mkpath
  ...
  describe "#to_latest_kegs" do
    before do
      ...
      (DRXHUB_CELLAR/"foo/2.0").mkpath
      (DRXHUB_CELLAR/"bar/1.0").mkpath
      (DRXHUB_CELLAR/"baz/HEAD-1").mkpath
      head2 = DRXHUB_CELLAR/"baz/HEAD-2"
      head2.mkpath
  ...
  describe "#to_installed_taps" do
    before do
      (DRXHUB_REPOSITORY/"Library/Taps/homebrew/homebrew-foo").mkpath
    end
