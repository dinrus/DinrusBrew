...
RSpec.describe DinrusHub::DevCmd::Ruby do
  it_behaves_like "parseable arguments"

  it "executes ruby code with DinrusHub's libraries loaded", :integration_test do
    expect { dhub "ruby", "-e", "exit 0" }
      .to be_a_success
  ...
  describe "-e 'puts \"testball\".f.path'", :integration_test, :needs_linux do
    ...
    it "prints the path of a test formula" do
      expect { dhub "ruby", "-e", "puts 'testball'.f.path" }
        .to be_a_success
