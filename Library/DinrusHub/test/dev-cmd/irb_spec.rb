...
RSpec.describe DinrusHub::DevCmd::Irb do
  ...
  describe "integration test" do
    ...
    it "starts an interactive DinrusHub shell session", :integration_test do
      setup_test_formula "testball"

      irb_test = DRXHUB_TEMP/"irb-test.rb"
      irb_test.write <<~RUBY
        "testball".f
        :testball.f
        exit
      ...
      expect { dhub "irb", irb_test }
        .to output(/Interactive DinrusHub Shell/).to_stdout
