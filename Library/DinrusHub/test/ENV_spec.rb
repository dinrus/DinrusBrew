  ...
  describe Superenv do
    ...
    describe "#cxx11" do
      it "supports gcc-11" do
        env["DRXHUB_CC"] = "gcc-11"
        env.cxx11
        expect(env["DRXHUB_CCCFG"]).to include("x")
        expect(env["DRXHUB_CCCFG"]).not_to include("g")
      end
      ...
      it "supports clang" do
        ...
        env.cxx11
        expect(env["DRXHUB_CCCFG"]).to include("x")
        expect(env["DRXHUB_CCCFG"]).to include("g")
      end
    end
    ...
    describe "#set_debug_symbols" do
      it "sets the debug symbols flag" do
        ...
        expect(env["DRXHUB_CCCFG"]).to include("D")
      end
    end
  end
end
