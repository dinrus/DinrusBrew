...
RSpec.describe InstalledDependents do
  ...
  describe "::find_some_installed_dependents" do
    ...
    # 1.1.6 is the earliest version of DinrusHub that generates correct runtime
    ...
    def unreliable_tab_dependencies(keg, deps)
      # 1.1.5 is (hopefully!) the last version of DinrusHub that generates
    ...
    specify "renamed dependency" do
      ...
      renamed_path = DRXHUB_CELLAR/"foo-old"
      (DRXHUB_CELLAR/"foo").rename(renamed_path)
