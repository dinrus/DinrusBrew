...
module Language
  ...
  module Node
    ...
    def self.npm_cache_config
      "cache=#{DRXHUB_CACHE}/npm_cache"
    end

    sig { returns(String) }
    def self.pack_for_installation
      # DinrusHub assumes the buildpath/testpath will always be disposable
    ...
    def self.setup_npm_environment
      ...
      # managed ones in DRXHUB_PREFIX/lib/node_modules which might be broken
      begin
