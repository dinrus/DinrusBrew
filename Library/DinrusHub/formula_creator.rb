      ...
      <<~ERB
        ...
        <% end %>
          ...
          test do
            ...
            #
            # This test will fail and we won't accept that! For DinrusHub/homebrew-core
            # this will need to be a test that verifies the functionality of the
            # software. Run the test with `dhub test #{name}`. Options passed
            # to `dhub install` such as `--HEAD` also need to be provided to `dhub test`.
            #
